...
const consumeMessageFromQueue = new ConsumeMessageFromQueueService(amqpLibRepository);
const sendConfirmationToClient = new SendConfirmationToClient(socketRepository);

const payOrder = new PayOrder(sendMessageToQueueService, consumeMessageFromQueue, sendConfirmationToClient);
